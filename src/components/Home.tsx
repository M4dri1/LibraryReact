  ...
  return (
    <div className="home-root">
      <div className={styles.homeHeader}>
        <div className={styles.container}>
          <div className={styles.brand} onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            ...
            <h1 className={styles.title}>BibliotecaLocal</h1>
          </div>
      ...
      <section className="testimonials">
        <div className="section-head">
          <h3>O que dizem sobre a BibliotecaLocal</h3>
        </div>
      ...
      <footer id="contato" className="home-footer">
        ...
        <p className="copyright">© {new Date().getFullYear()} BibliotecaLocal - Todos os direitos reservados</p>
      </footer>
    </div>
  );
};
